...
if (isset($_POST["submit"])) {
   ...
   if ($pictureArray->error === 0) {      
       ($_POST["picture"] == "avatar.png") ?: unlink("../userpictures/{$_POST["picture"]}");
   ...
   if (mysqli_query($connect, $sql) === true) {    
       ...
       header("refresh:3;url=userupdate.php?id={$id}");
   } else {
...
<div class="container">
   <div class="<?php echo $class; ?>" role="alert">
       ...
       <h2>Update</h2>       
       <img class='img-thumbnail rounded-circle' src='../userpictures/<?php echo $data['picture'] ?>' alt="<?php echo $f_name ?>">
